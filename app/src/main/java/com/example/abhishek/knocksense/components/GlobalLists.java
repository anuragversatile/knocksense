...
public class GlobalLists extends Application {
    ...
    public static void fetchHomeData(Context context) {
    ...
    public static void fetchCityData(Context context, String selectedCityId) {
    ...
    public static void fetchCategoryData(Context context) {
        final List<Article> articleList = new ArrayList<>();
                    ...
                    public void onResponse(String s) {
                        try {
                            ...
                            for (int i = 0; i < ParentArray.length(); i++) {
                                ...
                                articleModel.setCount(ParentObject.getString("count"));
                                Log.d("Article modal", "onResponse:" + articleModel);
                                articleList.add(articleModel);
                                if (articleList.size() == ParentArray.length()) {
