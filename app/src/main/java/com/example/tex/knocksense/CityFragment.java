...
public class CityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.example.tex.knocksense.R.layout.fragment_city, container, false);
        ...
        // Set the adapter
            ...
            RecyclerView recyclerView = (RecyclerView) view.findViewById(com.example.tex.knocksense.R.id.city_fragment_list);
            if (mColumnCount <= 1) {
