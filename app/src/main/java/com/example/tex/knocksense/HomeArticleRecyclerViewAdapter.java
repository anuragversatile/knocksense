...
import com.example.tex.knocksense.HomeFragment.OnListFragmentInteractionListener;
import com.example.tex.knocksense.components.Article;
import com.example.tex.knocksense.components.BigArticleViewHolder;
import com.example.tex.knocksense.components.CategoryViewHolder;
...
import com.example.tex.knocksense.components.SingleArticleViewHolder;
import com.example.tex.knocksense.components.TwoArticles;
import com.example.tex.knocksense.components.TwoArticlesViewHolder;
...
private Context context;
    ...
    public HomeArticleRecyclerViewAdapter(OnListFragmentInteractionListener listener,Context context,View view, HomeFragment homeFragment, OnCategoryClickListener onCategoryClickListener) {
        ...
        this.progressBar=(ProgressBar)view.findViewById(com.example.tex.knocksense.R.id.home_progress_bar);
        globalListInstance.registerObserver(ListNameConstants.HOME,this);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==BIG_ARTICLE){
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(com.example.tex.knocksense.R.layout.article_big_item_row, parent, false);
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(com.example.tex.knocksense.R.layout.article_two_item_row, parent, false);
            return new TwoArticlesViewHolder(view);
        }
        else if(viewType==CATEGORY){
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(com.example.tex.knocksense.R.layout.article_category_item_row, parent, false);
        ...
        if(temp==1 || temp==7) {
            ...
            holder.mView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    PopupMenu popup = new PopupMenu(context, holder.mView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more));
            ...
            */
            ...
            holder.leftArticleView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more_left).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //// TODO: 26-08-2017 save and share functionality
                    PopupMenu popup = new PopupMenu(context, holder.leftArticleView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more_left));
                    //inflating menu from xml resource
                    popup.inflate(com.example.tex.knocksense.R.menu.options_menu);
                    //adding click listener
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
          ...
          */
          ImageLoader.getInstance().displayImage(rightArticle.getFeaturedImage(), holder.rightImageView, new ImageLoadingListener() {
            ...
            holder.rightArticleView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more_right).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //// TODO: 26-08-2017 save and share functionality
                    PopupMenu popup = new PopupMenu(context, holder.rightArticleView.findViewById(com.example.tex.knocksense.R.id.article_item_row_more_right));
                    //inflating menu from xml resource
                    popup.inflate(com.example.tex.knocksense.R.menu.options_menu);
                    //adding click listener
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            holder.mView.findViewById(com.example.tex.knocksense.R.id.category_article_textView).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
