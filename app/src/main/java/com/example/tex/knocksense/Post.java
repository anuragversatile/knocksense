...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.tex.knocksense.R.layout.post);
...
Font font=new Font();
        ImageView iv=(ImageView)findViewById(com.example.tex.knocksense.R.id.featured);
        String feature=extras.getString("feature");
        Picasso.with(this).load(feature).into(iv);

        TextView tx=(TextView)findViewById(com.example.tex.knocksense.R.id.title);
        ...
        TextView tx1=(TextView)findViewById(com.example.tex.knocksense.R.id.date);
        TextView tx2=(TextView)findViewById(com.example.tex.knocksense.R.id.author);
        ...
        ImageView sharingButton = (ImageView)findViewById(com.example.tex.knocksense.R.id.article_item_row_more);
...
final Post that=this;
      sharingButton.setOnClickListener(new View.OnClickListener() {
        ...
        ImageView sharing = (ImageView)findViewById(com.example.tex.knocksense.R.id.facebook);
        ...
        ImageView sharingb = (ImageView)findViewById(com.example.tex.knocksense.R.id.facebookshare);
        ...
        ImageView sharingc = (ImageView)findViewById(com.example.tex.knocksense.R.id.whatsappshare);
        ...
        ImageView sharingd = (ImageView)findViewById(com.example.tex.knocksense.R.id.allshare);
        ...
        ImageView sharing1 = (ImageView)findViewById(com.example.tex.knocksense.R.id.whatsapp);
        ...
        ImageView back = (ImageView)findViewById(com.example.tex.knocksense.R.id.backs);
        ...
        content = (WebView)findViewById(com.example.tex.knocksense.R.id.contentPost);
