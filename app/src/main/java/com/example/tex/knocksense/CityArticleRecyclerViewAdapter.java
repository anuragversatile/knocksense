...
import com.example.tex.knocksense.CityFragment.OnListFragmentInteractionListener;
...
private static int normal=23245;
    ...
    public CityArticleRecyclerViewAdapter(OnListFragmentInteractionListener listener, Context context, View view,CityFragment cityFragment) {
        ...
        this.progressBar = (ProgressBar)view.findViewById(com.example.tex.knocksense.R.id.city_progress_bar);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        /*if(viewType==ads)
           ...
           if(viewType==bigArticle){
                View view = LayoutInflater.from(parent.getContext()).inflate(com.example.tex.knocksense.R.layout.article_big_item_row, parent, false);
