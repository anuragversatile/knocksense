...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.example.tex.knocksense.R.layout.fragment_home_article_list, container, false);
        ...
        // Set the adapter
            ...
            final RecyclerView recyclerView = (RecyclerView)view.findViewById(com.example.tex.knocksense.R.id.home_fragment_list);
            if (mColumnCount <= 1) {
